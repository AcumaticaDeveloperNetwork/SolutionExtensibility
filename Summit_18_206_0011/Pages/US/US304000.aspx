<%@ page language="C#" masterpagefile="~/MasterPages/FormDetail.master" autoeventwireup="true" validaterequest="false" codefile="US304000.aspx.cs" inherits="Page_US304000" title="Untitled Page" %>

<%@ mastertype virtualpath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="true" TypeName="USScouts.USSimpleInvoiceEntry" PrimaryView="Document">
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Selection" TabIndex="13900">
		<Template>
            ...
            <px:PXDateTimeEdit ID="edDate" runat="server" AlreadyLocalized="False" DataField="Date">
            </px:PXDateTimeEdit>
		    ...
		    <px:PXTextEdit ID="edInvoiceRef" runat="server" AlreadyLocalized="False" DataField="InvoiceRef" DefaultLocale="">
            </px:PXTextEdit>
		</Template>
	</px:PXFormView>
</asp:Content>
