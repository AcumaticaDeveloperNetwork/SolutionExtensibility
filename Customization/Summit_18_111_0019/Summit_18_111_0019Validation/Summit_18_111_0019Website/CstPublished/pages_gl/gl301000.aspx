		...
		<Levels>
			<px:PXGridLevel DataMember="GLTranModuleBatNbr">
				<RowTemplate>
					...
					<px:PXSegmentMask ID="edBranchID" runat="server" DataField="BranchID" OnValueChange="Commit" ></px:PXSegmentMask>
					<px:PXSelector runat="server" ID="CstPXSelector1" DataField="UsrUSLeaderID" />
					<px:PXTextEdit runat="server" ID="CstPXTextEdit2" DataField="UsrUSLeaderID_description" />
					<px:PXSegmentMask ID="edAccountID" runat="server" DataField="AccountID" AutoRefresh="True" OnValueChange="Commit" ></px:PXSegmentMask>
					<px:PXSegmentMask ID="edSubID" runat="server" DataField="SubID" AutoRefresh="True" OnValueChange="Commit" ></px:PXSegmentMask>
					<px:PXTextEdit ID="edRefNbr" runat="server" DataField="RefNbr" Size="S" ></px:PXTextEdit>
					<px:PXDateTimeEdit ID="edTranDate" runat="server" DataField="TranDate" Enabled="False" Size="S" ></px:PXDateTimeEdit>
					<px:PXSelector ID="edUOM" runat="server" DataField="UOM" AutoRefresh="True" OnValueChange="Commit" Size="S" ></px:PXSelector>
					<px:PXNumberEdit ID="edQty" runat="server" DataField="Qty" Size="S" ></px:PXNumberEdit>
					<px:PXNumberEdit ID="edCuryDebitAmt" runat="server" DataField="CuryDebitAmt" Size="S" ></px:PXNumberEdit>
					<px:PXNumberEdit ID="edCuryCreditAmt" runat="server" DataField="CuryCreditAmt" Size="S" ></px:PXNumberEdit>
					...
					<px:PXSegmentMask ID="edTaskID" runat="server" DataField="TaskID" CommitChanges="True" AutoRefresh="True" ></px:PXSegmentMask>
                    <px:PXSegmentMask ID="edCostCode" runat="server" DataField="CostCodeID" CommitChanges="True" AutoRefresh="True" ></px:PXSegmentMask>
					<px:PXSelector ID="edReferenceID" runat="server" DataField="ReferenceID" Enabled="False"></px:PXSelector>
					<px:PXSegmentMask ID="edInventoryID" runat="server" DataField="InventoryID" AllowEdit="True" Enabled="False" ></px:PXSegmentMask>
					<px:PXSegmentMask ID="edLedger" runat="server" DataField="LedgerID" AllowEdit="True" Enabled="False"></px:PXSegmentMask>
                    <px:PXSelector ID="edTaxID" runat="server" DataField="TaxID" AutoRefresh="True" OnValueChange="Commit" Size="S" ></px:PXSelector></RowTemplate>
				<Columns>
					<px:PXGridColumn DataField="UsrUSLeaderID_description" Width="200" />
					<px:PXGridColumn DataField="UsrUSLeaderID" Width="120" CommitChanges="True" />
					...
					<px:PXGridColumn DataField="AccountID" AutoCallBack="True" ></px:PXGridColumn>
					<px:PXGridColumn DataField="AccountID_Account_description" Width="120px" ></px:PXGridColumn>
					<px:PXGridColumn DataField="SubID" Width="120px" AutoCallBack="True"></px:PXGridColumn>
					<px:PXGridColumn DataField="ProjectID" Width="90px" AutoCallBack="true" ></px:PXGridColumn>
					<px:PXGridColumn DataField="TaskID" Label="Task" Width="90px" AutoCallBack="True" ></px:PXGridColumn>
                    <px:PXGridColumn DataField="CostCodeID" Label="Task" Width="90px" AutoCallBack="True" ></px:PXGridColumn>
					<px:PXGridColumn DataField="RefNbr" Width="90px" ></px:PXGridColumn>
					<px:PXGridColumn DataField="TranDate" Width="60px" DisplayFormat="d" ></px:PXGridColumn>
					<px:PXGridColumn DataField="Qty" TextAlign="Right" Width="81px" ></px:PXGridColumn>
					<px:PXGridColumn DataField="UOM" Width="54px" AutoCallBack="True" ></px:PXGridColumn>
					<px:PXGridColumn DataField="CuryDebitAmt" TextAlign="Right" Width="100px" ></px:PXGridColumn>
					<px:PXGridColumn DataField="CuryCreditAmt" TextAlign="Right" Width="100px" ></px:PXGridColumn>
					<px:PXGridColumn DataField="TranDesc" Width="180px" ></px:PXGridColumn>
					<px:PXGridColumn DataField="InventoryID" ></px:PXGridColumn>
					<px:PXGridColumn DataField="LedgerID" AllowShowHide="True" Visible="False" SyncVisible="False" ></px:PXGridColumn>
					<px:PXGridColumn DataField="ReferenceID" Width="100px" ></px:PXGridColumn>
                    <px:PXGridColumn DataField="TaxID" Width="100px" AutoCallBack="True" AllowShowHide="Server"></px:PXGridColumn>
                    <px:PXGridColumn DataField="TaxCategoryID" Width="100px" AutoCallBack="True" AllowShowHide="Server"></px:PXGridColumn>
                    <px:PXGridColumn DataField="NonBillable" Type="CheckBox" TextAlign="Center" ></px:PXGridColumn>
                    <px:PXGridColumn DataField="CuryReclassRemainingAmt" TextAlign="Right" Width="120px" AllowShowHide="Server" ></px:PXGridColumn>
                    <px:PXGridColumn DataField="ReclassBatchNbr" TextAlign="Right" Width="120px" LinkCommand="ViewReclassBatch" ></px:PXGridColumn>
                     
                    <px:PXGridColumn DataField="OrigModule" Width="100px"  AllowShowHide="Server"></px:PXGridColumn>
					<px:PXGridColumn DataField="OrigBatchNbr" Width="100px" LinkCommand="viewOrigBatch" AllowShowHide="Server"></px:PXGridColumn>
                    <px:PXGridColumn DataField="OrigLineNbr" TextAlign="Right" AllowShowHide="Server" ></px:PXGridColumn>
                    
                    <px:PXGridColumn DataField="IncludedInReclassHistory" AllowShowHide="False" Visible="false" SyncVisible="false" ></px:PXGridColumn></Columns>
