		...
		<Items>
			<px:PXTabItem Text="General Settings">
				<Template>
					...
					<px:PXSelector ID="edBatchNumberingID" runat="server" DataField="BatchNumberingID" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edInvoiceNumberingID" runat="server" DataField="InvoiceNumberingID" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edDebitAdjNumberingID" runat="server" DataField="DebitAdjNumberingID" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edCreditAdjNumberingID" runat="server" DataField="CreditAdjNumberingID" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edCheckNumberingID" runat="server" DataField="CheckNumberingID" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edPriceWSNumberingID" runat="server" DataField="PriceWSNumberingID" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector runat="server" ID="CstPXSelector1" DataField="UsrDSNumberingID" />
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Posting Settings" ></px:PXLayoutRule>
                    <px:PXDropDown ID="edDataInconsistencyHandlingMode" runat="server" DataField="DataInconsistencyHandlingMode" ></px:PXDropDown>
					<px:PXCheckBox SuppressLabel="True" ID="chkAutoPost" runat="server" DataField="AutoPost" AlignLeft="True" Size="Empty" ></px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkSummaryPost" runat="server" DataField="SummaryPost" AlignLeft="True" Size="Empty" ></px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkMigrationMode" runat="server" DataField="MigrationMode" AlignLeft="True" Size="Empty" CommitChanges="true" ></px:PXCheckBox>
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Aging Settings" ></px:PXLayoutRule>
					<px:PXLayoutRule runat="server" Merge="True" ></px:PXLayoutRule>
					<px:PXNumberEdit Size="xxs" ID="edPastDue00" runat="server" DataField="PastDue00" ></px:PXNumberEdit>
					<px:PXLabel Size="xs" ID="lblDays1" runat="server">Days</px:PXLabel>
					<px:PXLayoutRule runat="server" ></px:PXLayoutRule>
					<px:PXLayoutRule runat="server" Merge="True" ></px:PXLayoutRule>
					<px:PXNumberEdit Size="xxs" ID="edPastDue01" runat="server" DataField="PastDue01" ></px:PXNumberEdit>
					<px:PXLabel Size="xs" ID="lblDays2" runat="server">Days</px:PXLabel>
					<px:PXLayoutRule runat="server" ></px:PXLayoutRule>
					<px:PXLayoutRule runat="server" Merge="True" ></px:PXLayoutRule>
					<px:PXNumberEdit Size="xxs" ID="edPastDue02" runat="server" DataField="PastDue02" ></px:PXNumberEdit>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Data Entry Settings" StartGroup="True" ></px:PXLayoutRule>
					<px:PXSelector ID="edDfltVendorClassID" runat="server" DataField="DfltVendorClassID" AllowEdit="True" CommitChanges="true" ></px:PXSelector>
					<px:PXSegmentMask ID="edExpenseSubMask" runat="server" DataField="ExpenseSubMask" ></px:PXSegmentMask>
					<px:PXDropDown ID="edInvoiceRounding" runat="server" DataField="InvoiceRounding" CommitChanges="true" ></px:PXDropDown>
					<px:PXDropDown ID="edInvoicePrecision" runat="server" DataField="InvoicePrecision" ></px:PXDropDown>
					<px:PXLayoutRule runat="server" Merge="True" ></px:PXLayoutRule>
					<px:PXNumberEdit Size="xxs" ID="edPaymentLeadTime" runat="server" AllowNull="False" DataField="PaymentLeadTime" ></px:PXNumberEdit>
					<px:PXLabel Size="xs" ID="lblDays4" runat="server">Days</px:PXLabel>
					<px:PXLayoutRule runat="server" ></px:PXLayoutRule>
					<px:PXCheckBox ID="chkHoldEntry" runat="server" DataField="HoldEntry" CommitChanges="true" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkAutoPreapprovePayments" runat="server" DataField="RequireApprovePayments" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkEarlyChecks" runat="server" DataField="EarlyChecks" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkRequireControlTotal" runat="server" DataField="RequireControlTotal" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkRequireControlTaxTotal" runat="server" DataField="RequireControlTaxTotal" ></px:PXCheckBox>
                    <px:PXCheckBox ID="chkSuggestPaymentAmount" runat="server" DataField="SuggestPaymentAmount" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkRequireVendorRef" runat="server" DataField="RequireVendorRef" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkRaiseErrorOnDoubleInvoiceNbr" runat="server" DataField="RaiseErrorOnDoubleInvoiceNbr" ></px:PXCheckBox>
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Retainage Settings" ></px:PXLayoutRule>
					<px:PXCheckBox SuppressLabel="True" ID="chkRetainTaxes" runat="server" DataField="RetainTaxes" ></px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkRetainageBillsAutoRelease" runat="server" DataField="RetainageBillsAutoRelease" ></px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkRequireSingleProjectPerDocument" runat="server" DataField="RequireSingleProjectPerDocument" ></px:PXCheckBox>
					<px:PXLayoutRule runat="server" GroupCaption="VAT Recalculation Settings" StartGroup="True" ></px:PXLayoutRule>
					<px:PXTextEdit ID="txtPPDDebitAdjustmentDescr" runat="server" DataField="PPDDebitAdjustmentDescr" ></px:PXTextEdit></Template>
			</px:PXTabItem>
