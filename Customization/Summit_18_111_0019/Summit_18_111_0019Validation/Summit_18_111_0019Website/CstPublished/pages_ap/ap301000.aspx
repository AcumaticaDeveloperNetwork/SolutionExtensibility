						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions">
								...
								<RowTemplate>
									...
									<px:PXSelector runat="server" ID="CstPXSelector1" DataField="UsrUSLeaderID" CommitChanges="True" />
									...
									<px:PXSelector ID="edPPVRefNbr" runat="server" DataField="PPVRefNbr" Enabled="False" AllowEdit="True" ></px:PXSelector></RowTemplate>
