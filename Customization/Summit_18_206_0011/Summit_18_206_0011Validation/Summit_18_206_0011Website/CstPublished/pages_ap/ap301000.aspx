...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="300px" Style="z-index: 100;" Width="100%">
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions">
								<Columns>
									...
									<px:PXGridColumn DataField="UsrUSScoutID" Width="140" />
									...
									<px:PXGridColumn DataField="LCDocType" ></px:PXGridColumn>
									<px:PXGridColumn DataField="LCRefNbr" ></px:PXGridColumn>
									<px:PXGridColumn DataField="LCLineNbr" TextAlign="Right" ></px:PXGridColumn>
									...
									<px:PXGridColumn DataField="PPVRefNbr" TextAlign="Right" ></px:PXGridColumn></Columns>
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" ></px:PXLayoutRule>
									<px:PXSelector runat="server" ID="CstPXSelector1" DataField="UsrUSScoutID" />
									...
									<px:PXDropDown ID="edLCDocType" runat="server" DataField="LCDocType" Enabled="False" AllowEdit="True" ></px:PXDropDown>
									<px:PXSelector ID="edLCRefNbr" runat="server" DataField="LCRefNbr" Enabled="False" AllowEdit="True" ></px:PXSelector>
									<px:PXNumberEdit ID="edLCLineNbr" runat="server" DataField="LCLineNbr" Enabled="False" AllowEdit="True" ></px:PXNumberEdit></RowTemplate>
						...
						<ActionBar>
							<CustomItems>
								...
								<px:PXToolBarButton Text="Add PO Line" Key="cmdPOLine">
									<AutoCallBack Command="AddPOOrderLine" Target="ds" ></AutoCallBack>
								</px:PXToolBarButton>
								<px:PXToolBarButton Text="Add LC" Key="cmdLC">
									<AutoCallBack Command="AddLandedCost" Target="ds" ></AutoCallBack>
								</px:PXToolBarButton>
								<px:PXToolBarButton>
			...
			<px:PXTabItem Text="Simple Invoices">
				<Template>
					<px:PXGrid runat="server" ID="CstPXGrid2" SyncPosition="True" KeepPosition="True" DataSourceID="ds" Height="300px" SkinID="DetailsInTab" Width="100%">
						<Levels>
							<px:PXGridLevel DataMember="USSimpleInvoices">
								<Columns>
									<px:PXGridColumn DataField="RefNbr" Width="140" />
									<px:PXGridColumn DataField="Status" Width="70" />
									<px:PXGridColumn DataField="ScoutID" Width="140" />
									<px:PXGridColumn DataField="Date" Width="90" />
									<px:PXGridColumn DataField="Description" Width="280" /></Columns></px:PXGridLevel></Levels></px:PXGrid></Template></px:PXTabItem>
				...
				<Template>
					<px:PXFormView ID="form2" runat="server" Style="z-index: 100" Width="100%" DataMember="CurrentDocument" CaptionVisible="False" SkinID="Transparent" DataSourceID="ds" MarkRequired="Dynamic">
						<Template>
							...
							<px:PXSegmentMask CommitChanges="True" ID="edPayAccountID" runat="server" DataField="PayAccountID" DataSourceID="ds" AutoRefresh="true"></px:PXSegmentMask>
						...
						<Levels>
							<px:PXGridLevel DataMember="RetainageDocuments">
								<Columns>
									...
									<px:PXGridColumn DataField="APInvoice__PayTypeID" ></px:PXGridColumn>
									<px:PXGridColumn DataField="APInvoice__InvoiceNbr" Width="90px" ></px:PXGridColumn>
